...
description: 效能優化規範 — defineAsyncComponent/Lazy、並行 fetching、Bundle 體積與 tree-shaking、NuxtImg、虛擬捲動、Web Vitals (LCP/INP/CLS/TTFB)、測量工具 (Lighthouse/nuxt analyze)。當處理效能問題或調整 nuxt.config 時自動參考。
