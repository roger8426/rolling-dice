...
description: 測試規範 — Vitest、@vue/test-utils、@nuxt/test-utils、測試檔放置 (tests/unit/component/e2e)、撰寫原則、composable/component/store 測試策略、mock 原則、snapshot 與覆蓋率。當編輯測試檔或被要求補測試時自動參考。
